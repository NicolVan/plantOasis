...
namespace PlantOasis.lib.Util
{
    ...
    public class DateTimeUtil
    {
        ...
        public static DateTime? DisplayDateToDate(string displayDate, string separator = ".")
        {
            ...
            try
            {
                string[] items = displayDate.Split(new[] { separator, " " }, StringSplitOptions.RemoveEmptyEntries);
                if (items.Length != 3)
                    return null;
