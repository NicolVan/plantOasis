...
namespace PlantOasis.lib.Models
{
    public class CategoryModel : _BaseModel
    {
        ...
        public void CopyDataFrom(Category src)
        {
            if (src == null)
            {
                return;
        ...
        public void CopyDataTo(Category trg)
        {
            trg.pk = this.pk;
        ...
        public static CategoryModel CreateCopyFrom(Category src)
        {
        ...
        public static Category CreateCopyFrom(CategoryModel src)
        {
            Category trg = new Category();
            src.CopyDataTo(trg);
        ...
        public void LoadRelatives(CategoryRepository repository)
        {
            this.Children = GetChildren(repository, this.pk);
            this.Parents = GetParents(repository, this.pk);
        }

        public static List<CategoryModel> GetChildren(CategoryRepository repository, Guid categoryKey)
        {
            List<CategoryModel> dataList = new List<CategoryModel>();
            foreach (Category category in repository.GetRecordsForParent(categoryKey))
            {
        ...
        public static List<CategoryModel> GetParents(CategoryRepository repository, Guid categoryKey)
        {
            List<CategoryModel> dataList = new List<CategoryModel>();
    ...
    public class CategoryTree
    {
        ...
        public CategoryTree()
        {
            ...
            List<Category> dataList = repository.GetPage(1, _PagingModel.AllItemsPerPage, Guid.Empty).Items;
        ...
        void ResolveTreeChildren(CategoryModel parent, List<Category> dataList)
        {
            parent.Children = new List<CategoryModel>();
            foreach (Category category in dataList)
            {
