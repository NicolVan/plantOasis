...
namespace PlantOasis.lib.Models
{
    public class Product2AttributeModel : _BaseModel
    {
        ...
        public static List<Product2AttributeItem> LoadItems(Guid productKey)
        {
            ...
            // Load all attributes
            ProductAttributeRepository repAttr = new ProductAttributeRepository();
            foreach (ProductAttribute attr in repAttr.GetPage(1, _PagingModel.AllItemsPerPage).Items)
            {
            ...
            Product2AttributeRepository rep = new Product2AttributeRepository();
            List<Product2Attribute> dataList = rep.GetForProduct(productKey);
    ...
    public class Product2AttributeItem : _BaseModel
    {
        ...
        public void CopyDataFrom(Product2Attribute src)
        {
            this.pk = src.pk;
        ...
        public void CopyDataTo(Product2Attribute trg)
        {
            trg.pk = this.pk;
        ...
        public static Product2AttributeItem CreateCopyFrom(Product2Attribute src)
        {
        ...
        public static Product2Attribute CreateCopyFrom(Product2AttributeItem src)
        {
            Product2Attribute trg = new Product2Attribute();
            src.CopyDataTo(trg);
