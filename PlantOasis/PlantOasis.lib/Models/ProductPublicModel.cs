...
namespace PlantOasis.lib.Models
{
    public class ProductPublicModel
    {
        ...
        public ProductPublicModel(string url)
        {
            ...
            Product product = rep.GetForProductUrl(url);
            ...
            if (product != null)
            {
                ...
                // Product category
                List<Product2Category> p2cDataList = new Product2CategoryRepository().GetForProduct(product.pk);
    ...
    public class ProductPublicImagesModel
    {
        ...
        {
            this.Items = new FileUploadRepository().GetFiles(Product.GetFileUploadCategory(productKey));
        }
    }
}
