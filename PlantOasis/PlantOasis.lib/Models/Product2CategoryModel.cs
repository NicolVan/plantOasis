...
namespace PlantOasis.lib.Models
{
    public class Product2CategoryModel : _BaseModel
    {
        ...
        public void CopyDataFrom(Product2Category src)
        {
            this.pk = src.pk;
        ...
        public static Product2CategoryModel CreateCopyFrom(Product2Category src)
        {
    ...
    public class Product2CategoryItemsModel : _PagingModel
    {
        ...
        public static Product2CategoryItemsModel CreateCopyFrom(Page<Product2Category> src)
        {
            Product2CategoryItemsModel trg = new Product2CategoryItemsModel();
            trg.Items = new List<Product2CategoryModel>();
            foreach (Product2Category srcItem in src.Items)
            {
        ...
        public static Product2CategoryItemsModel CreateCopyFrom(Guid categoryKey, Page<Product> src, ProductModelDropDowns productDropDowns)
        {
            Product2CategoryItemsModel trg = new Product2CategoryItemsModel();
            trg.Items = new List<Product2CategoryModel>();
            int i = 0;
            foreach (Product srcItem in src.Items)
            {
                trg.Items.Add(
        ...
        public void BindProducts(List<Product> products, ProductModelDropDowns productDropDowns)
        {
    ...
    public class ProductInCategoryFilterModel : _BaseUserPropModel
    {
        ...
        public static ProductInCategoryFilterModel CreateCopyFrom(UserProp src)
        {
        ...
        public static UserProp CreateCopyFrom(ProductInCategoryFilterModel src)
        {
            src.UpdateAfterEdit();
    ...
    public class ProductNotInCategoryFilterModel : _BaseUserPropModel
    {
        ...
        public static ProductNotInCategoryFilterModel CreateCopyFrom(UserProp src)
        {
        ...
        public static UserProp CreateCopyFrom(ProductNotInCategoryFilterModel src)
        {
            src.UpdateAfterEdit();
            UserProp trg = new UserProp();
            src.CopyDataTo(trg);
    ...
    public class Product2CategoryEditModel
    {
        ...
        public void LoadCategories(_BaseController ctrl, Guid productKey)
        {
            ...
            foreach (Product2Category dataRec in new Product2CategoryRepository().GetForProduct(productKey))
            {
