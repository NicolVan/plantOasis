...
namespace PlantOasis.lib.Pdf
{
    public class PdfFonts
    {
        ...
        {
            this.DefaultColor = new BaseColor(60, 60, 60);
            this.PrimaryColor = new BaseColor(57, 149, 107);
            this.SecondaryColor = new BaseColor(62, 181, 126);
