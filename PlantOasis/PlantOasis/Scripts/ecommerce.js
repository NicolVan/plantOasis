$(document).ready(function () {
    ...
    // PlantOasis category detail product view type change
    $('.eccd-pvt').change(function () {
        ecCategoryPublicFilterModel_ProductViewType(this);
    });
    // PlantOasis category detail product sort type change
    $('.eccd-pst').change(function () {
        ecCategoryPublicFilterModel_ProductSortType(this);
    });
    // PlantOasis category detail product producer selection change
    $('.eccd-prodsel').change(function () {
        ecCategoryPublicFilterModel_ProducerIsSelected(this);
    });
    // PlantOasis category detail product attribute selection change
...
function ecClearSessionData() {
    $.ajax('/Umbraco/PlantOasis/EshopApi/ClearSessionData',
        {
            type: 'POST',
...
function ecAddProductCnt2Quote(quoteId, productId, memberId, infoId, modalId, cnt) {
    ...
    $.ajax('/Umbraco/PlantOasis/QuoteApi/AddProductToQuote/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Result == "OK") {
...
function ecSaveProduct2Quote(quoteId, productId, infoId) {
    ...
    $.ajax('/Umbraco/PlantOasis/QuoteApi/SaveProductToQuote/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Result == "OK") {
                ecReloadPage();
...
function ecRemoveProduct2Quote(quoteId, productId, infoId) {
    ...
    $.ajax('/Umbraco/PlantOasis/QuoteApi/RemoveProductToQuote/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Result == "OK") {
...
function ecUpdateBasketQuickView(quoteId, memberId) {
    ...
    //$.ajax('/Umbraco/PlantOasis/QuoteApi/BasketQuickViewInfo/?id=' + param, {
    //    type: 'POST',
    //    success: function (data) {
    //        if (data.Result == "OK") {
...
function ecAddProduct2Category(catid, prodid) {
    ...
    $.ajax('/Umbraco/PlantOasis/Product2CategoryApi/AddProductToCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecRemoveProduct2Category(catid, prodid) {
    ...
    var param = catid + '|' + prodid;
    $.ajax('/Umbraco/PlantOasis/Product2CategoryApi/RemoveProductToCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveUpProduct2Category(catid, prodid) {
    ...
    var param = catid + '|' + prodid;
    $.ajax('/Umbraco/PlantOasis/Product2CategoryApi/MoveUpProductToCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveDownProduct2Category(catid, prodid) {
    ...
    var param = catid + '|' + prodid;
    $.ajax('/Umbraco/PlantOasis/Product2CategoryApi/MoveDownProductToCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveUpCategory(parentid, catid) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/MoveUpCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveDownCategory(parentid, catid) {
    ...
    var param = parentid + '|' + catid;
    $.ajax('/Umbraco/PlantOasis/CategoryApi/MoveDownCategory/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveUpProduct(id) {
    ...
    $.ajax('/Umbraco/PlantOasis/ProductApi/MoveUpProduct/?id=' + id, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveDownProduct(id) {
    ...
    $.ajax('/Umbraco/PlantOasis/ProductApi/MoveDownProduct/?id=' + id, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveUpProductAttribute(id) {
    ...
    $.ajax('/Umbraco/PlantOasis/ProductApi/MoveUpProductAttribute/?id=' + id, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecMoveDownProductAttribute(id) {
    ...
    $.ajax('/Umbraco/PlantOasis/ProductApi/MoveDownProductAttribute/?id=' + id, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCalculatePriceWithoutVat(el) {
    ...
    $.ajax('/Umbraco/PlantOasis/ProductApi/CalculatePriceWithoutVat/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Status == 'OK') {
...
function ecCategoryPublicFilterModel_PageSize(sessionId, pageSize) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_PageSize_Set/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_ProductViewType(sessionId, viewType) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProductView_Set/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_ProductSortType(el) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProductSort_Set/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_ProducerIsSelected(el) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProducerIsSelected_Set/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_AllProducers(sessionid, setSelected) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProducerIsSelected_All/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_ProductAttributeIsSelected(el) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProductAttributeIsSelected_Set/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecCategoryPublicFilterModel_AllProdAttrs(sessionid, setSelected) {
    ...
    $.ajax('/Umbraco/PlantOasis/CategoryApi/CategoryPublicFilterModel_ProductAttributeIsSelected_All/?id=' + param, {
        type: 'POST',
        success: function (data) {
            ecReloadPage();
        },
...
function ecRelatedProductAutocomplete(selector, spinner) {
    $(selector).autoComplete({
        ...
        source: function (term, response) {
            ...
            ec_relatedprodsearch_xhr = $.ajax('/Umbraco/PlantOasis/ProductApi/SearchProduct?id=' + term,
                {
                    type: 'POST',
                    success: function (data) {
                        response(data);
...
function ecProductPriceAutocomplete(selector, spinner, linkid) {
    $(selector).autoComplete({
        ...
        source: function (term, response) {
            ...
            ec_prodpricesearch_xhr = $.ajax('/Umbraco/PlantOasis/ProductApi/SearchProduct?id=' + term,
                {
                    type: 'POST',
                    success: function (data) {
                        response(data);
...
function naplnspajzuQuoteSetState(el) {
    ...
    $.ajax('/Umbraco/PlantOasis/QuoteApi/ChangeQuoteState/?id=' + param, {
        type: 'POST',
        success: function (data) {
            console.log(data);
            if (data.Result == 'OK') {
...
function ecInitProductSearchUI(url) {
    ...
    if ($('.category-detail-search').length > 0) {
        $('a.menu-item-search').on('click', function () {
            ...
            console.log($('a.menu-item-search'));
...
function ecAddProduct2Favorite(productId, memberId, infoId) {
    ...
    $.ajax('/Umbraco/PlantOasis/FavoriteProductApi/AddProductToFavorite/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Result == "OK") {
...
function ecRemoveProduct2Favorite(productId, memberId, infoId) {
    ecBeforeReloadPage();
    var param = productId + '|' + memberId;
    $.ajax('/Umbraco/PlantOasis/FavoriteProductApi/RemoveProductToFavorite/?id=' + param, {
        type: 'POST',
        success: function (data) {
            if (data.Result == "OK") {
                ecReloadPage();
